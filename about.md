...
- __HOMEWORLD BIG FILE BUILDER & PARSER__
...
- __PERSONNEL REACTIVE LIB / ALL__
...
- __NETWORK TCP SOCKET LIB / ALL__

  C 기반의 TCP/IP 소켓 라이브러리 개발

  뭐~ 이런 것을 만드는데 능숙한 모양입니다. 일주일 걸렸네요.

- __ANDROID MESSAGE APP / ANDROID__
...
- __2D BOARD GAME TO HTML5 / ALL__
...
- __ANDROID WIFI SHARE APP / ANDROID DEV__
...
- __ANDROID MESH USING BLUETOOTH / ALL__
...
- __MEDIA CONVERTER / ALL__

  FFMPEG 을 이용한 미디어 컨버터를 만드는 것으로 서비스 가능한 컨버터를 하루 이틀 만에 만든 것입니다.

- __DISTRIBUTED IN-MEMORY CACHE SYSTEM / ALL__
...
- __PERSONNEL OPENGL UTIL / ALL__

  개인적으로 Freeglut 같은 Library 를 만들었던 경험이 있습니다.

- __AUTOMATED DOOR LOCK SYSTEM / ALL__
...
- __DATABASE MIGRATION / ALL__

  그 당시는 좋은 마이그레이션 툴이 없었기 때문에 간단한 마이그레이션 툴을 만들고 작업을 진행하였습니다.

- __MP3 PLAYER / APPLICATION DEV__
...
- __HR SYSTEM USING AUTOMATION / ALL__
